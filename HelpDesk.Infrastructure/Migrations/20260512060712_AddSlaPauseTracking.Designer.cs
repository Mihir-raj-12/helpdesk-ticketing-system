...
namespace HelpDesk.Infrastructure.Migrations
{
    ...
    [Migration("20260512060712_AddSlaPauseTracking")]
    partial class AddSlaPauseTracking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HelpDesk.Core.Entities.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HelpDesk.Core.Entities.NotificationPreference", b =>
                {
                    ...
                    b.Property<bool>("OptOutCsatSurveys")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("HelpDesk.Core.Entities.PublicHoliday", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HelpDesk.Core.Entities.RecurringTicket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("RaiseOnBehalfOfUserId")
                        .IsRequired()
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("RaiseOnBehalfOfUserId");

                    b.ToTable("RecurringTickets");
                });

            modelBuilder.Entity("HelpDesk.Core.Entities.SlaConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HelpDesk.Core.Entities.SystemSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<TimeSpan>("BusinessHourEnd")
                        .HasColumnType("time");

                    b.Property<TimeSpan>("BusinessHourStart")
                        .HasColumnType("time");
            ...
            modelBuilder.Entity("HelpDesk.Core.Entities.Ticket", b =>
                {
                    ...
                    b.Property<bool?>("SlaClosedWithinSla")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("HelpDesk.Core.Entities.TicketFeedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HelpDesk.Core.Entities.ApplicationUser", b =>
                {
                    b.HasOne("HelpDesk.Core.Entities.Department", "Department")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("HelpDesk.Core.Entities.Department", b =>
                {
                    b.HasOne("HelpDesk.Core.Entities.ApplicationUser", "DepartmentHead")
                        .WithMany()
            ...
            modelBuilder.Entity("HelpDesk.Core.Entities.KbArticleVersion", b =>
                {
                    b.HasOne("HelpDesk.Core.Entities.KbArticle", "KbArticle")
                        .WithMany()
            ...
            modelBuilder.Entity("HelpDesk.Core.Entities.RecurringTicket", b =>
                {
                    b.HasOne("HelpDesk.Core.Entities.ApplicationUser", "AssignToUser")
                        .WithMany()
                    ...
                    b.HasOne("HelpDesk.Core.Entities.ApplicationUser", "RaiseOnBehalfOfUser")
                        .WithMany()
                        .HasForeignKey("RaiseOnBehalfOfUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("RaiseOnBehalfOfUser");
                });
            ...
            modelBuilder.Entity("HelpDesk.Core.Entities.Ticket", b =>
                {
                    ...
                    b.HasOne("HelpDesk.Core.Entities.Ticket", "RelatedTicket")
                        .WithMany()
            ...
            modelBuilder.Entity("HelpDesk.Core.Entities.TicketFeedback", b =>
                {
                    b.HasOne("HelpDesk.Core.Entities.ApplicationUser", "SubmittedByUser")
                        .WithMany()
